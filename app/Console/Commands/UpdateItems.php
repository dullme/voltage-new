    ...
    public function updateHarness()
    {
        ...
        $data = collect($data['value'])->map(function ($item) use($client){
            ...
            return [
                ...
                'min_length' => $item['Harness_Min_Length'],
                'max_length' => $item['Harness_Max_Length'],
                'have_fuse' => $item['Harness_Has_Fuse'],
                'fuse' => $item['Harness_Fuse'],
                'string' => $item['Harness_Strings'],
                'outlet_length' => $item['Outlet_Length'],
                'module' => $item['Harness_Module'],
                'created_at' => $item['Date'],
                'updated_at' => $item['Date'],
                'items' => $data
            ];
