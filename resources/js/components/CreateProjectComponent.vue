                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="btn-group pull-right" style="margin-right: 5px">
                            <a href="/admin/projects" class="btn btn-sm btn-default" title="List" target="_self">
                    ...
                    <div class="box-body">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group  ">
                                    <label class="col-sm-2 asterisk control-label">支架种类</label>
                                    <div class="col-sm-8">
                                        <select class="form-control" id="brackets" name="brackets" v-model="project_form.brackets" multiple="multiple">
                                            <option v-for="specification in brackets" :value="specification.id">{{ specification.name }}</option>
                                        </select>
                                    </div>
                                </div>

                                <div class="form-group  ">
                                    <label class="col-sm-2 asterisk control-label">太阳能板种类</label>
                                    <div class="col-sm-8">
                                        <select class="form-control" id="solar_panels" name="solar_panels" v-model="project_form.solar_panels" multiple="multiple">
                                            <option v-for="panel in solar_panels" :value="panel.id">{{ panel.name }}</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="row">
                                            <div class="col-sm-2 mb15">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" v-model="project_form.r_cbx_1_1">
                                                </div>
                                            </div>
                                            <div class="col-sm-2 mb15">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" v-model="project_form.r_cbx_1_2">
                                                </div>
                                            </div>
                                            <div class="col-sm-2 mb15">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" v-model="project_form.r_cbx_1_3">
                                                </div>
                                            </div>
                                            <div class="col-sm-2 mb15">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" v-model="project_form.r_cbx_1_4">
                                                </div>
                                            </div>

                                            <div class="col-sm-1 mb15">
                                                <div class="input-group">
                                                    <span class="form-control" style="padding: 6px 0px;border: unset">
                                                        {{ parseInt(project_form.r_cbx_1_1) + parseInt(project_form.r_cbx_1_2) + parseInt(project_form.r_cbx_1_3) + parseInt(project_form.r_cbx_1_4) }}
                                                    </span>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group  " v-if="project_form.layout_of_whip == 2">
                                    <label class="col-sm-2 asterisk control-label">Rowhead to CBX'</label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                            <div class="col-sm-2 mb15">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" v-model="project_form.r_cbx_2_1">
                                                </div>
                                            </div>
                                            <div class="col-sm-2 mb15">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" v-model="project_form.r_cbx_2_2">
                                                </div>
                                            </div>
                                            <div class="col-sm-2 mb15">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" v-model="project_form.r_cbx_2_3">
                                                </div>
                                            </div>
                                            <div class="col-sm-2 mb15">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" v-model="project_form.r_cbx_2_4">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-1 mb15">
                                                <div class="input-group">
                                                    <span class="form-control" style="padding: 6px 0px;border: unset">
                                                        {{ parseInt(project_form.r_cbx_2_1) + parseInt(project_form.r_cbx_2_2) + parseInt(project_form.r_cbx_2_3) + parseInt(project_form.r_cbx_2_4) }}
                                                    </span>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group  ">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="row" v-if="checkbox_list.connector || checkbox_list.fuse">
                                            <div class="col-sm-12 mb15" v-if="checkbox_list.fuse">
                                                <div class="input-group">
    ...
    export default {
        ...
        mounted(){
            ...
            $('#brackets').select2({
                ...
                this.project_form[e.target.name] = $('#brackets').val() == null ? [] : $('#brackets').val()
            })

            $('#solar_panels').select2({
                placeholder : 'Please choose',
                allowClear: true, //选中项可清空
                maximumSelectionLength:10,
            }).on('change', (e) => {
                this.project_form[e.target.name] = $('#solar_panels').val() == null ? [] : $('#solar_panels').val()
            })
